...
void DDImage::BltF(Image* theImage, float theX, float theY, const Rect& theSrcRect, const Rect& theClipRect, const Color& theColor, int theDrawMode)
{
	...
	{
		BltRotated(theImage, theX, theY, theSrcRect, theClipRect.Intersection(Rect(0, 0, BOARD_WIDTH + mDDInterface->mWideScreenExtraWidth, BOARD_HEIGHT + mDDInterface->mWideScreenExtraHeight)), theColor, theDrawMode, 0, 0, 0);
	}
}
